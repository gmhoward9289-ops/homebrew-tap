...
#   curl -sL https://github.com/gmhoward9289-ops/leghorn/releases/download/v0.4.1/leghorn-0.4.1.tar.gz | shasum -a 256
class Leghorn < Formula
  ...
  url "https://github.com/gmhoward9289-ops/leghorn/releases/download/v0.4.1/leghorn-0.4.1.tar.gz"
  sha256 "f85ae8bab9720c345315cf92e20038ca90b7799a30038814ebacf2a14511dadc"
  version "0.4.1"
  license "MIT"
