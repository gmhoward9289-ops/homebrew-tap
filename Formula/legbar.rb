...
#   curl -sL https://github.com/gmhoward9289-ops/legbar/releases/download/v0.3.9/legbar-0.3.9.tar.gz | shasum -a 256
class Legbar < Formula
  ...
  url "https://github.com/gmhoward9289-ops/legbar/releases/download/v0.3.9/legbar-0.3.9.tar.gz"
  sha256 "1ccd9474d719f49c56702211a5bf4fe676797bdf0872313850ed02098f35d2f0"
  version "0.3.9"
  license "Apache-2.0"
