...
#   curl -sL https://github.com/gmhoward9289-ops/legbar/releases/download/v0.3.4/legbar-0.3.4.tar.gz | shasum -a 256
class Legbar < Formula
  ...
  url "https://github.com/gmhoward9289-ops/legbar/releases/download/v0.3.4/legbar-0.3.4.tar.gz"
  sha256 "88238832a8b15419bc5db7638f56bf0fdb837bface84089fbe7448665a86b1d1"
  version "0.3.4"
  license "Apache-2.0"
